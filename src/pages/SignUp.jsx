                    ...
                    <h2 className='text-[24px] text-[#5e5e5e] text-center px-16 md:px-0  mb-[24px]'>Get better data with conversational forms, surveys, quizzes & more.</h2>
                    {
                        form ? <>
                            <form className='flex flex-col justify-center items-center gap-2' onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {errors.email && <span className='text-red-500 text-[14px]'>Email is required</span>}
                                ...
                                {errors.terms && <span className='text-red-500 w-[252px] text-[14px]'>Please accept the terms and conditions to finish the signup</span>}
                                <div className="collapse w-[242px] text-[14px] collapse-arrow">
                                    ...
                                    <div className="collapse-content">
                                        <div className='mb-2'>
                                            ...
                                            <input className='mx-2' type="radio" {...register("newsletter")} />
                                            <label >Yes</label>
                                            <input className='mx-2' type="radio" {...register("newsletter")} />
                                            <label>No</label>
                                        </div>
