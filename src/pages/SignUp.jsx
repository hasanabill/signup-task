...
const SignUp = () => {
    return (
        <>
            <div className="w-[870px] h-screen text-white absolute flex flex-col justify-center items-center " >
            ...
            <div className="flex flex-col justify-between bg-[#ffffff] w-[1064px] h-screen absolute right-0 rounded-s-2xl">
                <div className='flex justify-between px-[24px] py-[8px] h-[52px]'>
                    ...
                    <div className='flex items-center gap-2'>
                        <h2 className='text-[16px]'>Already have an account?</h2>
                        <a href='#' className='text-[12px] px-[10px] py-[3px] border border-black rounded-md'>Log in</a>
                    </div>
                </div>

                <div className=' flex flex-col gap-3 justify-center items-center max-w-[542px] mx-auto'>
                    ...
                    <h2 className='text-[24px] text-[#5e5e5e] text-center mb-[24px]'>Get better data with conversational forms, surveys, quizzes & more.</h2>
